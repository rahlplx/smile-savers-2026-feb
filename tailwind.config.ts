...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // Typography Scale
      fontSize: {
        'elderly-base': ['1.125rem', { lineHeight: '1.7', letterSpacing: '0.02em' }],
        'elderly-lg': ['1.25rem', { lineHeight: '1.6' }],
      },
      ...
      // Screens/Breakpoints (Enterprise Standard)
      screens: {
        'xs': '320px',
        'sm': '640px',
        'md': '768px',
